...
int using_bin (int argc, char *argv[])
{
  GMainLoop *loop = NULL;
  ...
  GstPad *source_pad = NULL, *decoder_pad = NULL;
  ...
  // gst_element_add_pad(bin, gst_ghost_pad_new("sink", source_pad));
  gst_element_add_pad(bin, gst_ghost_pad_new("src", decoder_pad));
  ...
  g_object_set (G_OBJECT (pgie),
      "config-file-path", "apps/using_bin/using_bin_config.txt", NULL);
